...
<link rel="stylesheet" type="text/css" href="css/concursos.css">
<div class="container">
	<div class="row">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h1><span class="blue-arrow-right"></span> CONCURSOS PÚBLICOS</h1>
		</div>
	</div>
	<div class="row">
				...
				<div class="row">
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<p>
							...
							para cargos de níveis médio e superior, e formação de cadastros de reserva. Os profissionais devem acessar
							o site da organizadora, entre os dias 9 e 22 de Novembro...
						</p>
					</div>
					<a href="#">DETALHES</a>
				</div>
